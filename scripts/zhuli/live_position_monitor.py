...
HELD = [
    ...
    {
        'ticker': '1303', 'name': '南亞',
        'cost': 104.5, 'shares': 1000, 'stop': 92.7,
        'strategy_mode': 'swing',
        'tactic': '題材', 'priority': 3,
        'source': '老師明示 6/5 Stage 1 1/3',
        'sector': 'ABF/塑化',
        'note': '6/5 Stage 1 進 1 張 @ $104.5 (老師明示「今天 1/3、下週一 1/3」、目標 3 張 ≈$313k ≈10% 水位)、停損 MA20 $92.7、Stage 2 下週一看條件再加 1 張'
    },
    {
        'ticker': '3264', 'name': '欣銓',
        'cost': 228.5, 'shares': 1000, 'stop': 226.1,
        'strategy_mode': 'swing',
        'tactic': '核心', 'priority': 3,
        'source': '老師 6/3 圈起來中長期',
        'sector': '半導體封測',
        'note': '6/5 進 1 張 @ $228.5、老師 6/3 圈起來中長期 (IC 測試)、外資佈局上櫃、N 字回測完成。停損 MA20 $226.1 (緊)、結構底 $214.0 (硬)'
    },
    {
        'ticker': '6257', 'name': '矽格',
        'cost': 223.0, 'shares': 1000, 'stop': 219.9,
        'strategy_mode': 'swing',
        'tactic': '核心', 'priority': 3,
        'source': '老師 6/3 圈起來中長期',
        'sector': '半導體封測 / IC 測試',
        'note': '6/5 進 1 張 @ $223、老師 6/3 圈起來中長期、距 MA10 +0.3% 打擊區。停損 MA20 $219.9 (緊)、結構底 MA60 $181.3 (硬)'
    },
]
