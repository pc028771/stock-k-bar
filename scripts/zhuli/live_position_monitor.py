...
HELD = [
    # 6285: 6/1 1 張 @ 315 + 6/2 1 張 @ 312 (老師明示「兩檔選啟碁」)
    # 均 313.5、2 張、不違紀 (老師明示 override 技術加碼條件)
    ('6285', '啟碁', 313.5, 2000, 307.4),
    ('1605', '華新', 40.1,  8000, 38.75),
    # 6/2 4939 亞電 6 張 @ 51 (📰 外部消息單、混合判讀)
    # Entry: 消息派 (AI 不評論)
    # Exit: 技術派、停損 50.1 (今日低)
    # 尾盤判: 收紅 K + 不破 50.1 → 留 / 否則全出
    ('4939', '亞電', 51.0,  6000, 50.1),
]
...
# 觀察清單 (回測 MA10 守住才重評進場): (tk, name, ref_close, stop, kind)
# 結構壞掉的 (3189/8021/4958/3037/1717) 已移出、由 AI 內部追蹤
WATCH = [
    ('6207', '雷科',   122.5, 115.0, '🟡 6/1 V 轉、6/2 跳空 +4.9% 紅線 #1 skip、等 6/3 回測 MA10 ~115-120 守住'),
    ('8046', '南電',   862.0, 850.0, '🔴 6/2 拉積盤 -4.31%、等回測 856-870 (MA5/10) 守住'),
    ('4722', '國精化', 281.0, 268.0, '🔒A 但流動性差 + D+5 時機尾、等 6/5 出關前 2 天'),
]
