...
HELD = [
    ...
    #   元大四維6/26+719抄底但短沖製造反彈、拉高就丟。老師「破線沒未來」決斷
    {
        ...
        'cost': 58.0, 'shares': 1000, 'stop': 64.99,
        'strategy_mode': 'core',       # 核心配置、汰弱剩尾
        'tactic': '汰弱剩尾', 'priority': 3,
        'source': '配置部位、汰弱中',
        'sector': '金融',
        'note': '7/1 對帳單: 共賣9張 (3張@$66.3+2張@$66.4+2張@$66.0+2張@$66.4)、淨收$594,477、已實現+$72,477(+13.9%)。原掛太高的3張後來成交2張、實際剩1張。汰弱理由: 外資6/30轉賣-8,587、非老師8主軸、鎖利籌彈藥。剩1張=拉高再賣or收破月線$64.99出、小尾巴不急'
    },
