...
HELD = [
    ...
    {
        'ticker': '3481', 'name': '群創',
        'cost': 69.0, 'shares': 2000, 'stop': 58.5,
        'strategy_mode': 'disposal_swing',  # 處置股紀律: stop = 今日 L (trailing up)
        'tactic': '題材', 'priority': 3,
        'source': '老師明示 6/3 + 6/22 加碼 (黃大外部消息)',
        'sector': '面板/族群補漲',
        'note': '⚠️2026-06-28 對帳更正: 券商加權平均成本 ~$69(非我之前誤記的分倉$58.7)。一路買賣churn後剩2張、券商avg ~$69、6/26收$65 = -5.74%虧損(非我以為的爽倉)。我「砍貴留便宜$58.7」是心智模型、券商用加權平均不認lot。外資連倒(6/26 -152k巨派發!)、stop $58.5(離成本-16%偏寬)。盯外資止血、不加'
    },
