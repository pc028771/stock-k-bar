...
HELD = [
    ...
    {
        'ticker': '3481', 'name': '群創',
        'cost': 63.7, 'shares': 2000, 'stop': 58.5,
        'strategy_mode': 'disposal_swing',  # 處置股紀律: stop = 今日 L (trailing up)
        'tactic': '題材', 'priority': 3,
        'source': '老師明示 6/3 + 6/22 加碼 (黃大外部消息)',
        'sector': '面板/族群補漲',
        'note': '🔒 6/4 進處置→6/18 出關。6/22 加碼共4張 @均$63.7。⚠️ 6/24 拉高汰弱賣2張 (1@$67.6 + 1@$68.1、+~$8k)、理由: 外資20d倒53萬張巨派發 + 老師今天課程零提及 + 無分點override(不像華新有館前哥)、趁開低走高拉高出貨高峰落袋。剩2張、守 $66 收盤線、續拉高可再汰、收破$66跑。20d外資派發是籌碼軸唯一壞、消息面(黃大)撐剩倉'
    },
