...
HELD = [
    ...
    {
        'ticker': '3481', 'name': '群創',
        'cost': 63.85, 'shares': 4000, 'stop': 58.5,
        'strategy_mode': 'disposal_swing',  # 處置股紀律: stop = 今日 L (trailing up)
        'tactic': '題材', 'priority': 3,
        'source': '老師明示 6/3 + 6/22 加碼 (黃大外部消息)',
        'sector': '面板/族群補漲',
        'note': '2張@$58.7(原始安全倉) + 2張@$69(6/24買回)= 4張均$63.85。6/24 收$69.4 守五日線MA5$64.9(+6.9%)、買回未追漲停$72.6高點。⚠️但外資連倒未停(6/22 -117k/6/23 -24k/6/24 -25k、5日~-20萬張) + 老師6/24晚課:群創=共識太強到貨風險、這週收手。【管理】買回2張@$69=風險倉、守五日線$64.9收破先汰這2張(老師anchor破+外資倒贏);核心2張@$58.7用真結構$58.5(大緩衝爽倉)。盯外資哪天止血轉買才算安全。不再加'
    },
