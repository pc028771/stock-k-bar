...
HELD = [
    ...
    #   元大四維6/26+719抄底但短沖製造反彈、拉高就丟。老師「破線沒未來」決斷
    {
        ...
        'cost': 58.0, 'shares': 3000, 'stop': 64.99,
        'strategy_mode': 'core',       # 核心配置、汰弱中
        'tactic': '汰弱剩尾', 'priority': 3,
        'source': '配置部位、汰弱中',
        'sector': '金融',
        'note': '7/1 分批賣: 早盤$66.3-66.4 拉高賣7張 (~+$58k realized、+14.4%)。剩3張限價掛太高沒成交、元大金回落$65.4。汰弱理由: 外資6/30轉賣-8,587(撐盤外資走)、非老師8主軸、+13%鎖利籌彈藥。剩3張=拉高再賣(掛~$66別太高)or收破月線$64.99出。⚠️對帳單待user補、確認7張成交價'
    },
    ...
    {
        'ticker': '2303', 'name': '聯電',
        'cost': 174.0, 'shares': 2000, 'stop': 143.2,
        'strategy_mode': 'swing',
        'tactic': '戰略級', 'priority': 3,
        'source': '老師明示 6/14 戰略級 + 黃大大波段(65%權重) + 6/16「黑K+籌碼漂亮」',
        'sector': '成熟製程',
        'note': '原4張(6/17$139/6/18$144/6/23$171/6/25$178)。6/29 減半賣2張@$161.5。⚠️券商FIFO=賣掉便宜的$139+$144、剩貴的2張$171+$178=成本$174(對帳用此、非加權平均$158)。已實現(FIFO賣便宜張)=($161.5-$141.5)×2000=+$40k已落袋;剩2張@$174在$166是-$16k浮虧、聯電整體+$24k。留賭7/8(外資5d+40k逆勢買=真強、躲處置養波段)。生死線=月線MA20 $143.2(老師6/28破月線沒未來)、收破出。加碼等N字第一根(放量站穩$172+/突破$178、守$164)、別追'
    },
    {
