...
HELD = [
    ...
    {
        'ticker': '3481', 'name': '群創',
        'cost': 58.7, 'shares': 2000, 'stop': 53.0,
        'strategy_mode': 'disposal_swing',  # 處置股紀律: stop = 今日 L (trailing up)
        'tactic': '題材', 'priority': 3,
        'source': '老師明示 6/3 + 處置中 (6/17 處置最後一天、6/18 出關)',
        'sector': '面板/族群補漲',
        'note': '🔒 6/4 D+1 進處置、6/15-16 站回 MA10、6/17 漲停 +9.94% @$58.6 (出關前一天確認反轉)、stop trailing $51→$53 (今日 L $53.2)、6/18 出關當天觀察、續強再 trailing up、回吐 → 守 $53'
    },
