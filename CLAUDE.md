...
0. **🔴🔴 大盤過熱 / 老師示警 → 主動跳出來提醒崩盤教訓（user PTSD、親口要求、見 `feedback_market_top_ptsd_reminder`）**：看到「大盤漲太多/創高/連漲 + 老師說站賣方/還會跌/別衝 + user 高水位(>6成) + 拉高出貨型態」任一 → **不等 user 問、當下一句剎車提醒**：「漲太多了、記得 6 月史上最大賣超你 80% 沒減、6/29 認賠 ~$99k、趁拉高減水位別追紅」+ 問「要不要趁這波拉高減？」。**追紅倉 = 短線不長抱（user 自訂）**、別幫他把追紅論述成波段。
