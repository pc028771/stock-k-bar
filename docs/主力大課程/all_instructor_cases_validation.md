...
> 案例總數：38 cases（H 5 + M 2 + J 2 + A 4 + D 3 + G 3 + C 3 + B 2 + I 9 + F 4 + E 1）
> **判定：✅ PASSED**
...
| ticker | name | date | result | category | note |
|---|---|---|---|---|---|
| 2351 | 順德 | 2021-06-22 | ? error | other (error) | ⚠️ Ch6-2 10:06 — 進 117 出 125。bandwidth_prev=0.278 不符合 spec「< 6%」。Case 為老師精選非速篩。 |
| 6271 | 同欣電 | 2021-06-22 | ? error | other (error) | ⚠️ Ch6-2 08:29 — ~210.5 → 211 隔日。bandwidth_prev=0.202 不符 spec「< 6%」。 |
| 3149 | 立達 | 2021-06-22 | ? error | other (error) | ⚠️ Ch6-2 05:51 — 漲停。bandwidth_prev=0.333 不符 spec「< 6%」。 |
...
| ticker | name | date | result | category | note |
|---|---|---|---|---|---|
| 3042 | 晶技 | 2021-03-11 | ✓ hit | strict_hit | Sprite scan F102-F119 (61:19~71:32) — 3042 晶技完整 5 形態組合 (反轉+旗型+中軌+上軌+回補缺口)。2021-02-22 D 觸發 → 回測 MA20 量縮 → 2021-03-11 起第二波啟動。 |
